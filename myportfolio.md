...
|---------|-------------|-----------|-------|
| **PARROT** | Unified communication platform with distributed microservices architecture featuring user authentication, profile/contact management, and real-time messaging. Implements JWT-based auth, WebSocket support for live message delivery, inter-service authorization, and production-grade deployment with Docker support | React.js (Vite), Flask, Django REST Framework, Channels, PostgreSQL, Redis, Docker, Microservices | [Live](https://parrot-react.onrender.com) / [Docs](https://github.com/Kishore-83096/My-Portfolio-/blob/main/PARROT.md) |
