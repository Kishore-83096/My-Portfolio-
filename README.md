...
| **📝 [Online Assessment Platform](https://github.com/Kishore-83096/react-django_OA_project)** | Platform to create, assign, and evaluate coding & MCQ-based assessments online. | `Django` `Python` `JavaScript` `HTML/CSS` `MY Sql` 'React js'|
